...
function log$1(method, message, vm) {
...
function logError(message, vm) {
  log$1('error', message, vm);
}

function logWarn(message, vm) {
  log$1('warn', message, vm);
}
/*
 * Copyright (c) 2018, salesforce.com, inc.
 * All rights reserved.
...
function stylesheet$b(token, useActualHostSelector, useNativeDirPseudoclass) {
  ...
  return ["*", shadowSelector, " {margin: 0;padding: 0;font-size: 24px;}div", shadowSelector, "{text-align: center;}.topPane", shadowSelector, "{top: 20px;position: relative;}.controlsPane", shadowSelector, " {bottom: 15%;position: absolute;min-width: 350px;left: 50%;margin-left: -175px;}.submittedCountPane", shadowSelector, "{color:whitesmoke;bottom: 10%;position: absolute;min-width: 350px;left: 50%;margin-left: -175px;}input", shadowSelector, "{margin-top: 10px;margin-bottom: 10px;}button", shadowSelector, ", input[type=button]", shadowSelector, "{font-size: 1rem;border-radius: 5px;padding: 5px;color:rgb(50, 50, 50);background-color: rgb(200, 200, 200);margin: 5px;width: 220px;-webkit-appearance: none;}button:enabled", shadowSelector, ", input[type=button]:enabled", shadowSelector, "{cursor: pointer;}button:disabled", shadowSelector, ", input[type=button]:disabled", shadowSelector, " {color: whitesmoke;background-color: lightgray;}button:hover:enabled", shadowSelector, "{background-color: rgb(180, 180, 180);}.innerContainer", shadowSelector, "{display: flex;justify-content: center;width: 60%;height: 100%;min-height: 100%;margin: auto auto;}@media only screen and (max-width: 700px) {.innerContainer", shadowSelector, "{width: 100%;}}"].join('');
}
...
function getGame(gamenum) {
  log('client.game.getGame', gamenum); // need to get game by 4 digit id first...
...
function updateGameTopic(gamenum, topic) {
  const gameInfo = {
    topic
...
function tmpl$7($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("newgame", {
    ...
    key: 2
  }, [api_text("Newgame: Wait for people to join and then choose a topic")]), api_element("br", {
    key: 3
  }, []), api_element("br", {
    key: 4
  }, []), api_element("div", {
    key: 5
  }, [api_text("Player List: ")]), api_element("br", {
    key: 6
  }, []), api_element("div", {
    key: 7
  }, [api_text(api_dynamic_text($cmp.playerlist))])]), api_element("div", {
    classMap: {
      "controlsPane": true
    },
    key: 8
    ...
    key: 10
  }, []), api_element("datalist", {
    attrs: {
      "id": api_scoped_id("topics")
    },
    key: 11
  }, [api_element("option", {
    attrs: {
    ...
    key: 12
  }, [api_text("Movies")]), api_element("option", {
    attrs: {
      "value": "Albums"
    },
    key: 13
  }, [api_text("Albums")]), api_element("option", {
    attrs: {
      "value": "Books"
    },
    key: 14
  }, [api_text("Books")]), api_element("option", {
    attrs: {
      "value": "Foods"
    },
    key: 15
  }, [api_text("Foods")]), api_element("option", {
    attrs: {
      "value": "Places"
    },
    key: 16
...
class NewGame extends LightningElement {
  ...
  top3Topic(e) {
    ...
    updateGameTopic(SESSION.gameNum, SESSION.gameTopic).then(response => {
...
function tmpl$6($api, $cmp, $slotset, $ctx) {
  ...
  }, [api_text("Submit")])]), api_element("div", {
    classMap: {
      "submittedCountPane": true
    },
    key: 12
  }, [api_text("Submitted Count: " + api_dynamic_text($cmp.playerssubmitted))])])];
}
...
class EnterTop3 extends LightningElement {
  ...
  submitTop3() {
    ...
    submitPlayerTop3(SESSION.playerId, top1, top2, top3).then(response => {
      log('client.enterTop3.submitTop3.response', JSON.stringify(response)); // lwc event - handled by app.js 
...
function tmpl$5($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("waitingvote", {
    ...
    key: 2
  }, [api_text("Waiting for players to submit, and voting to start...")])]), $cmp.isHost ? api_element("div", {
    classMap: {
      "controlsPane": true
    },
    key: 3
    ...
    key: 4,
    on: {
      "click": _m0 || ($ctx._m0 = api_bind($cmp.startVoting))
    }
  }, [api_text("Start Voting")])]) : null, api_element("div", {
    classMap: {
      "submittedCountPane": true
    },
    key: 5
...
registerDecorators(WaitingVote, {
  publicProps: {
    playerssubmitted: {
      config: 0
    }
...
function tmpl$4($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("voting", {
    ...
    key: 2
  }, [api_text("Time for voting")]), api_element("br", {
    key: 3
  }, []), api_element("h2", {
    key: 4
  }, [api_text("Who's is this Top 3...?")]), api_element("br", {
    key: 5
  }, []), api_element("table", {
    key: 6
  }, [api_element("colgroup", {
    key: 7
  }, [api_element("col", {
    classMap: {
      "col1": true
    ...
    key: 12
  }, [api_text("Top 1")]), api_element("td", {
    key: 13
  }, [api_text(api_dynamic_text($cmp.top1))])]), api_element("tr", {
    key: 14
  }, [api_element("td", {
    key: 15
  }, [api_text("Top 2")]), api_element("td", {
    key: 16
  }, [api_text(api_dynamic_text($cmp.top2))])]), api_element("tr", {
    key: 17
  }, [api_element("td", {
    key: 18
  }, [api_text("Top 3")]), api_element("td", {
    key: 19
  }, [api_text(api_dynamic_text($cmp.top3))])])])]), $cmp.isRevealed ? api_element("div", {
    classMap: {
      "revealPane": true
    },
    attrs: {
  ...
  }, [api_text("Reveal")]) : null, $cmp.isHost ? api_element("br", {
    key: 30
  }, []) : null, $cmp.isHost ? api_element("input", {
    attrs: {
      "data-id": "nextButton",
      "type": "button",
  ...
  }, []) : null, $cmp.isHost ? api_element("br", {
    key: 32
    ...
    key: 33
  }, [api_text("Vote Count: " + api_dynamic_text($cmp.voteCount))])])];
}
...
function tmpl$3($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("results", {
    ...
    key: 2
  }, [api_text("Final Scores")]), api_element("br", {
    key: 3
  }, [])]), api_element("div", {
    key: 4
  }, [api_element("table", {
...
function stylesheet$1(token, useActualHostSelector, useNativeDirPseudoclass) {
  var shadowSelector = token ? ("[" + token + "]") : "";
  return ["errormsg", shadowSelector, "{top: 40%;position: absolute;width:300px;min-width: 300px;height:60px;line-height: 60px;left: 50%;margin-left: -150px;}.errmsg", shadowSelector, "{border-radius: 10px;background-color: rgb(255, 225, 225);border-color: red;border-style: solid;text-align: center;}"].join('');
}
...
function stylesheet(token, useActualHostSelector, useNativeDirPseudoclass) {
  var shadowSelector = token ? ("[" + token + "]") : "";
  return ["footer", shadowSelector, " {background-color: rgb(100,100,100);height: 50px;line-height: 50px;position: fixed;left: 0;bottom: 0;width: 100%;}.innerContainer", shadowSelector, "{justify-content: space-evenly;color: whitesmoke;}button", shadowSelector, "{width:auto;}.debugPane", shadowSelector, "{position: absolute;bottom: 0px;right: 0px;}"].join('');
}
...
class App extends LightningElement {
  ...
  handleStateChange(evt) {
    ...
    if (evt.detail.name === 'TopicSelected') {
      ...
      socket.emit('top3topic', SESSION); //update session state and ui
