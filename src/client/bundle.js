...
function tmpl$4($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("header", {
    ...
    key: 1
  }, [api_text("Top3 Header")]), api_element("h2", {
    classMap: {
      "nickname": true
    },
    key: 2
  }, [api_text(api_dynamic_text($cmp.nickname))])])];
}
var _tmpl$4 = registerTemplate(tmpl$4);
tmpl$4.stylesheets = [];
tmpl$4.stylesheetToken = "ui-header_header";
...
tmpl$2.stylesheets = [];
tmpl$2.stylesheetToken = "ui-newgame_newgame";
...
function tmpl($api, $cmp, $slotset, $ctx) {
  ...
  return [api_custom_element("ui-header", _uiHeader, {
    ...
    key: 2
  }, [api_text("body of app html")]), $cmp.isInLobbyPhase ? api_custom_element("ui-lobby", _uiLobby, {
    key: 3,
    on: {
      "phase_change": _m0 || ($ctx._m0 = api_bind($cmp.handlePhaseChange))
    }
  }, []) : null, $cmp.isNewGamePhase ? api_custom_element("ui-newgame", _uiNewgame, {
    key: 4,
    on: {
      "phase_change": _m1 || ($ctx._m1 = api_bind($cmp.handlePhaseChange))
    }
